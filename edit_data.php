				...
				<div class="icons-box-vert-container">
					<form name="form1" method="post" action="aksi_edit_data.php">  
					  <table width="400" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFF99" bgcolor="#FF0000">  
						<tr bgcolor="#FFFFCC">  
						  <td height="50" colspan="2"><div align="center">EDIT RESEP</div></td>  
						</tr>  
					 <?php  
					  mysql_connect('localhost','root','');  
					  mysql_select_db('crudakun');  
						
					  $sqlTampil="select * from masakan Where kd_masakan='$_GET[kd_masakan]'";  
					...
					<tr bgcolor="#FFFFFF">  
						  ...
						  <td>:  
						  <input name="nama_masakan" type="text" id="nama_masakan" value="<?php echo $dataTampil['nama_masakan']; ?>"></td>  
						</tr>  
						<tr bgcolor="#FFFFFF">  
						  <td height="40">Jenis Masakan</td>  
						  <td>:  
						  <input name="jenis_masakan" type="text" id="jenis_masakan" value="<?php echo $dataTampil['jenis_masakan']; ?>"></td>  
						</tr>  
						<tr bgcolor="#FFFFFF">  
						  <td height="40">Keterangan</td>  
						  <td>:  
						  <input name="keterangan" type="text" id="keterangan" value="<?php echo $dataTampil['keterangan']; ?>"></td>  
						</tr>  
						<tr bgcolor="#FFFFFF">  
						  <td>&nbsp;</td>  
